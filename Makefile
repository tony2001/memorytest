...
jemalloc: memorytest.c zmalloc.c config.h
	gcc -DUSE_JEMALLOC $(FLAGS) --std=gnu99 -g3 -O0 -o memorytest memorytest.c zmalloc.c -pthread -ljemalloc

tcmalloc: memorytest.c zmalloc.c config.h
	gcc -DUSE_TCMALLOC $(FLAGS) --std=gnu99 -g3 -O0 -o memorytest memorytest.c zmalloc.c -pthread -ltcmalloc
